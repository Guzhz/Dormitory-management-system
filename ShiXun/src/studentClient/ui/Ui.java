...
public class Ui {
	...
	public static void setFrameImage(JFrame jf, String imageName) {
		...
		Image i = tk.getImage("src\\studentClient\\image\\"+imageName);
		jf.setIconImage(i);
	}
	
	//设置图片界面返回一个面板
	public static JPanel setBackstageUI (JFrame jf) {
		Icon i = new ImageIcon("src\\studentClient\\image\\ui1.jpg");
	...
	public static JPanel setBackstageUI2 (JFrame jf) {
		Icon i = new ImageIcon("src\\studentClient\\image\\ui2.jpg");
		JLabel jl = new JLabel(i);
		JPanel jp = new JPanel();
